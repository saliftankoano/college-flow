  ...
  return (
    <>
      <section className="greenSection w-full h-[90%] bg-[#004439]">
        ...
        <div className="right mt-6 inline-flex justify-center items-center md:inline-flex md:w-[90%] md:mx-[5%] lg:inline-flex lg:w-[90%] lg:mx-[5%] xl:flex xl:justify-end xl:mt-[-35%]">
          <img
