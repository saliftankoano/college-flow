...
export default function StudentAccount() {
  ...
  const firebaseProfile = auth.currentUser.photoURL;
  ...
  return (
    <>
      ...
      >
        {showPanel && (
          <div className={`student-panel inline-flex`}>
            <div className="left">
              <img
              ...
              <div className="z-10 info flex w-[60%] mt-[-80%] pt-[5%] ml-[22%]">
                <div
                  className={`top-card w-full mt-[-2%] px-[5%] bg-white border-[#0D1717] border-[1px] border-opacity-20 rounded-xl`}
                >
                  <img
                    className="mx-auto pt-5"
                    src={firebaseProfile != null ? firebaseProfile : profile}
                    alt="profile picture"
                  />
